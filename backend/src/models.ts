...
export interface EstadoJogoMemoria {
  sessoes: Map<number, SessaoJogo>;
  jogadores: Map<string, Jogador>;
  respostasPendentes: Map<number, RespostaPendente[]>;
}

export const gameCards: Carta[] = [
  {
    id: 1,
